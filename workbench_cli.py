...
TASKS = {
    ...
    "5": {
            "name": "Translate",
            "prompt": "You are a experienced Hindia Language translator and interpreter. Translate the user's text into Hindi, maintaining the original meaning and tone.",
        },
}
